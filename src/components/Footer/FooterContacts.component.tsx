...
const linkAddress = "https://www.google.com/maps/search/1234+Sample+Street+Austin+Texas+78704/@30.2415626,-97.8098698,13z/data=!3m1!4b1?entry=ttu";
	...
	return (
		<ul className="flex flex-col justify-between h-4/5">
			{contacts.map(({address, icon}, index) => (
				<li key={nanoid()} className="flex gap-5">
					<Image src={icon} width={20} height={20} alt="contact icon" />
