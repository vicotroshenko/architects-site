  ...
  return (
    <>
      <button
        ...
        onClick={onClick}
        name={direction}
        className="flex items-center justify-center border border-gray-f2 min-h-[53px] backdrop-blur w-[53px] transition duration-300 hover:shadow-3xl-dark focus:shadow-3xl-dark "
        aria-label={label}
      >
        <ArrowIcon
          width={24}
